...
public class EffectsFragment extends BaseFragment {
    ...
    public static EffectsFragment newInstance(ArrayList<Attribute> attributes) {
        EffectsFragment myFragment = new EffectsFragment();
    ...
    private void loadAttributes() {
        ...
        for (Attribute attribute : attributes) {
            if (attribute.getType().equals(getString(R.string.effects))) {
                attrs.add(attribute);
            }
        }
