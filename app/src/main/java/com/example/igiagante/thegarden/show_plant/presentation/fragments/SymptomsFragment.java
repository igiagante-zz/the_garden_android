...
public class SymptomsFragment extends BaseFragment {
    ...
    public static SymptomsFragment newInstance(ArrayList<Attribute> attributes) {
        SymptomsFragment myFragment = new SymptomsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View fragmentView = inflater.inflate(R.layout.symptoms_fragment, container, false);
